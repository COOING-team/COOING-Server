...
public class AnswerController {
    ...
    public ResponseEntity<String> saveAudioFile(@RequestParam("audioFile") MultipartFile multipartFile) {
    ...
    public ResponseEntity<String> createAnswerData(@RequestBody CreateAnswerRequest createAnswerRequest) {
        return ResponseEntity.ok(answerService.createAnswer(createAnswerRequest));
    }
